...
- Нейросетевая система, основанная на свертночной нейронной сети (CNN).
### Решение
Нейросетевая система, основанная на свертночной нейронной сети (CNN).
### Обоснование
...
- Свёрточные слои используют разделяемые веса (parameter sharing) [3], благодаря чему количество параметров и занимаемая память значительно меньше [1], чем у MLP при работе с изображениями большого размера.
### Последствия
